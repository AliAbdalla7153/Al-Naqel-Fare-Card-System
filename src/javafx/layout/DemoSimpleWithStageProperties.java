...
public class DemoSimpleWithStageProperties extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Button button10= new Button("Click me");
        //Define a layout
        HBox root =new HBox();
        ...
        root.getChildren().addAll(button4,button5,button6,button7,button8);
